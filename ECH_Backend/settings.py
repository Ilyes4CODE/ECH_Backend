"""
Django settings for ECH_Backend project.
...
SECRET_KEY = 'django-insecure-m*18z5qjol(&q^j)*#@g4n&ah%og!1mmnw^(4&mfjqivc___s*'
...
ASGI_APPLICATION = 'ECH_Backend.asgi.application'
REST_FRAMEWORK = {
...
# Allow custom headers (X-User-Lang for i18n, plus default DRF + Auth headers)
